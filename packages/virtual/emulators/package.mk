...
LIBRETRO_CORES="81-lr a5200-lr arduous-lr atari800-lr beetle-gba-lr beetle-lynx-lr beetle-ngp-lr beetle-pce-lr beetle-pce-fast-lr    \
                ...
                duckstation-lr duckstation-sa  fake08-lr fbalpha2012-lr              \
                ...
                gambatte-lr gearboy-lr gearcoleco-lr gearsystem-lr genesis-plus-gx-lr genesis-plus-gx-wide-lr      \
                  hatari-lr    mame2003-plus-lr mame2010-lr mame2015-lr melonds-lr      \
                mesen-lr mgba-lr mojozork-lr mu-lr mupen64plus-lr mupen64plus-nx-lr neocd_lr nestopia-lr    \
                o2em-lr opera-lr parallel-n64-lr pcsx_rearmed-lr picodrive-lr           \
                prosystem-lr     quicknes-lr        \
                 smsplus-gx-lr snes9x-lr snes9x2002-lr snes9x2005_plus-lr snes9x2010-lr  \
                 swanstation-lr  vba-next-lr                \
                  virtualjaguar-lr  yabasanshiro-lr"

### Emulators or cores for specific devices
case "${DEVICE}" in
  AMD64)
    [ "${ENABLE_32BIT}" == "true" ] && EMUS_32BIT="lutris-wine"
    PKG_EMUS+="  cemu-sa dolphin-sa mednafen melonds-sa minivmacsa mupen64plus-sa kronos-sa        \
               nanoboyadvance-sa pcsx2-sa rpcs3-sa  vita3k-sa xemu-sa"
  ...
  RK3588*)
    ...
    PKG_EMUS+="  aethersx2-sa dolphin-sa  melonds-sa mupen64plus-sa box64    \
               yabasanshiro-sa  beetle-saturn-lr mednafen"
  ...
  RK3399)
    [ "${ENABLE_32BIT}" == "true" ] && EMUS_32BIT="box86 desmume-lr gpsp-lr pcsx_rearmed-lr"
    PKG_EMUS+="  aethersx2-sa dolphin-sa  melonds-sa mupen64plus-sa box64    \
               yabasanshiro-sa  nanoboyadvance-sa mednafen"
  ...
  S922X*)
    ...
    PKG_EMUS+="  aethersx2-sa dolphin-sa  mupen64plus-sa yabasanshiro-sa     \
                box64 "
  ...
  RK3326*)
    ...
    PKG_EMUS+="   mupen64plus-sa  yabasanshiro-sa  mednafen"
